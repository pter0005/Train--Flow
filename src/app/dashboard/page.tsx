      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-7">
        <Card className="col-span-1 lg:col-span-4">
          ...
          <CardContent className="pl-2">
            <p className="text-muted-foreground">Recent student activities and workout completions will be shown here.</p>
          </CardContent>
        </Card>
        <Card className="col-span-1 lg:col-span-3">
          ...
          <CardContent>
            <p className="text-muted-foreground">A list of scheduled workouts for today and tomorrow will appear here.</p>
          </CardContent>
        </Card>
      </div>
    </>
